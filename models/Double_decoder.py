...
class Model(nn.Module):
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec,
        ...
        enc_out = self.decoder1(enc_out, x_mask=dec_self_mask, cross_mask=dec_enc_mask, missing_mask=enc_missing) 
        ...
        dec_out = self.decoder2(dec_out, enc_out, x_mask=dec_self_mask, cross_mask=dec_enc_mask, missing_mask=dec_missing, cross_missing_mask=enc_missing)  # [(bs*channel) x output_patch_num x patch_len]
