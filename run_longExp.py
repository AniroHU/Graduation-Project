...
if __name__ == '__main__':
    ...
    # PhysioNet2012 连续时间嵌入 & 不规则时序相关参数
    parser.add_argument('--time_aware', action='store_true', default=False,
                        help='use continuous time embedding instead of positional encoding')
    parser.add_argument('--time_embed_type', type=str, default='continuous',
                        choices=['continuous', 'time2vec'],
                        help='type of continuous time embedding')
    parser.add_argument('--resample_interval', type=float, default=1.0,
                        help='PhysioNet2012: resample interval in hours')
    parser.add_argument('--max_hours', type=float, default=48.0,
                        help='PhysioNet2012: max time span in hours')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            #     args.distil,
            #     args.des,ii)
            setting = '{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_dt{}_fore{}_norm{}_{}_{}'.format(
                args.model_id,
                args.model,
                args.data,
                args.features,
        ...
        ii = 0
        setting = '{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_dt{}_norm{}_{}_{}'.format(args.model_id,
                                                                                                    args.model,
                                                                                                    args.data,
                                                                                                    args.features,
                                                                                                    args.seq_len,
